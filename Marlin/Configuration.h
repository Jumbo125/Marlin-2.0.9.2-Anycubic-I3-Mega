...
#define STRING_CONFIG_H_AUTHOR "(Jumbo125, default config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // i3 Mega stock v5 hotend, 40W heater cartridge (3.6Ω @ 22°C)
    ...
    #define DEFAULT_Kp_LIST {  12.71,  12.71 }
    #define DEFAULT_Ki_LIST {   0.73,   0.73 }
    #define DEFAULT_Kd_LIST {  55.17,  55.17 }
  #else
...
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. // false Jumbo125
...
#define Z2_DRIVER_TYPE ALL_DRIVERS_TYPE //jumbo125
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 94.29 }
...
#define XY_PROBE_FEEDRATE (133*60) //133*60 Jumbo125
...
#if DISABLED(I3MEGA_HAS_BLTOUCH)
  //#define MESH_BED_LEVELING //jumbo125
   #define AUTO_BED_LEVELING_BILINEAR //Jumbo125
#endif
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  //Jumbo125
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.1  // (mm) Comment out to use the last-measured height //jumbo125
#endif
 ...
 */
#define SD_CHECK_AND_RETRY  //Jumbo125
